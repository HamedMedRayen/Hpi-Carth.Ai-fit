...
export default function Exercises() {
  ...
  useEffect(() => {
    ...
    api.getExercises(filters)
      .then(data => { setExercises(data); setTotalCount(data.length); })
      .catch(() => { })
  ...
  return (
    <div style={{ minHeight: "100vh", paddingBottom: 100 }}>
      <Header title="Exercises" subtitle={`${totalCount} exercises found`} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 20, marginBottom: 20 }}
          ...
          <div style={{ ...glassCard, padding: 20 }}>
            ...
            {loading ? (
              ...
              <div style={{ textAlign: "center", color: "var(--color-text-3)", padding: 32 }}>
                No exercises found
              </div>
            ) : (
